...
export class NotificationGateway
    ...
    async handleGetNotifications(
        ...
        try {
            ...
            throw new WsException(`Failed to retrieve notifications: ${error.message}`);
        }
    }
    ...
    async handleMarkAllNotificationsAsRead(
        ...
        try {
            ...
            const result = await this.notificationService.markAllNotificationAsRead(userId);
            client.emit('notificationsRead', result);
        } catch (error) {
            throw new WsException(`Failed to mark all notifications as read: ${error.message}`);
        }
    }
    ...
    async handleMarkOneNotificationsAsRead(
        ...
        try {
            ...
            throw new WsException(`Failed to mark notification as read: ${error.message}`);
        }
    }
