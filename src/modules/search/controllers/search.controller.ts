...
export class SearchController {
    ...
    public async search(
        ...
        const documents = result.map((hit: any) => ({
            id: hit._id,
            filename: hit._source.originalFilename,
    ...
    public async suggest(
        ...
        // Transform to return minimal data for suggestions/autocomplete
        const suggestions = result.map((hit: any) => ({
            id: hit._id,
            filename: hit._source.originalFilename,
            tags: hit._source.tags,
        })) || [];
    ...
    @ApiOperation({ summary: 'Debug: Sync all documents from database to Elasticsearch' })
